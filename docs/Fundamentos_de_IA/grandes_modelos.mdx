...
| **15 fev 2024** | **[Sora Preview](https://openai.com/research/video-generation-model)** – Modelo texto‑→‑vídeo da OpenAI (acesso restrito). Gera vídeos de até 1 min com cenas complexas. | *Multimodal Models* |
